<template>
  <footer class="seperator-compensate highlight highlight-gray">
    <div class="container">
      <div class="row">
        ...
        <div class="col">
          <a href="https://twitter.com/wanderer_ai" class="twitter" title="Twitter link">
        ...
        <div class="col">
          <a href="https://github.com/wanderer-ai" class="github" title="Github link">
