<template>
    ...
    <div class="separator-wrapper">
      ...
      <header>
        ...
        <section-half-height class="highlight-gray">
      ...
      <main>
        ...
        <div class="container seperator-compensate text-spacing">
          ...
          <h3>CloudFalre</h3>
          <p>
            This website uses CloudFlare services for resolving the domain Wanderer.ai and to ensure SSL encryption.
            That means that requests to the webserver will be resolved by using CloudFlare and that the request data will be transmitted to their servers.
            <a href="https://www.privacyshield.gov/participant?id=a2zt0000000GnZKAA0&amp;status=Active">CloudFlare is part of the Privacy Shield Framework</a>
          </p>

          <h3>GitHub</h3>
          <p>
            This website is part of an open source project. To be transparent to the open source community this website is hostet on GitHub.
            That means that requests you make to this website will be answered by servers from GitHub.
            <a href="https://www.privacyshield.gov/participant?id=a2zt000000001K2AAI&amp;status=Active">GitHub ist part of the Privacy Shield Framework</a>
          </p>
...
import SectionHalfHeight from '~/components/SectionHalfHeight.vue'

export default {
  components: {
    AppNav, AppFooter, SectionHalfHeight
  }
}
